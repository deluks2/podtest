...
SpatiaLite is smoothly integrated into SQLite to provide a complete and powerful Spatial DBMS (mostly OGC-SFS compliant).
  ...
  s.ios.deployment_target = '8.0'
	...
	s.source_files = '*.h', 'src/{gaiaaux,gaiageo}/gg_*.c', 'src/{connection_cache,control_points,dxf,gaiaexif,geopackage,md5,shapefiles,spatialite,srsinit,versioninfo,virtualtext,wfs}/*.c'
	s.preserve_path = 'src/**/*.h', 'src/**/*.c'
